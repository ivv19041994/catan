...
Следующий практический этап — заменить прототипные меши и текстовые обозначения
на художественные ассеты и иконки. После этого команды можно переносить на
