...
игрового действия. По умолчанию файл находится в
`Saved/SaveGames/lan-host.catan`; путь для тестов можно переопределить параметром
`-CatanSaveFile=/absolute/path/game.catan`. В сохранение не входят сетевые токены:
