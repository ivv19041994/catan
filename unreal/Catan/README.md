...
Следующий практический этап — иконки ресурсов и карт, анимация кубиков,
строительства и перемещения разбойника, затем звук. После этого команды можно
переносить на authoritative server.
