...
Следующий практический этап — интерфейс торговли между игроками и с банком,
затем экран завершения партии. После завершения локального игрового цикла
можно переносить команды на authoritative server.
